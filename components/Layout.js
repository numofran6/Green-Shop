	...
	return (
		<>
			...
			<div className="min-h-screen flex flex-col justify-between">
				<header className="md:sticky md:top-0 z-20 bg-emerald-900">
					<nav className="flex justify-between items-center px-5 sm:px-10 h-16 shadow-md">
						<Link
							href={'/'}
							className="text-green-100 hover:text-green-300 active:text-green-100 flex items-center font-bold text-xl md:text-2xl uppercase"
						>
							<GiShoppingBag className="w-11 h-11 mr-2" />
							Green Shop
						</Link>

						<div className="space-x-4 md:flex uppercase font-semibold text-md hidden">
							<Link href="/">Home</Link>
					...
					{active && (
						<div className="absolute top-16 w-full h-fit flex flex-col justify-center items-center bg-emerald-900 space-y-10 py-10 text-center z-10">
