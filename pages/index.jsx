			...
			<header className="h-[55vh] md:h-[60vh] lg:h-[70vh] relative bg-emerald-900 overflow-hidden">
				...
				{active && (
					<motion.div
						...
						variants={list}
						ref={wrapperRef}
						className="absolute top-16 w-full min-h-[49vh] flex flex-col justify-center items-center bg-emerald-900 space-y-3 text-center z-10"
					>
				...
				<div className="lg:hidden absolute top-0 h-full w-full flex flex-col space-y-3 items-center justify-center text-white text-center bg-emerald-800 bg-opacity-80">
					<div className="h-7" />
					<h1 className="font-bold text-lg uppercase text-green-600">
						Green Shop
					</h1>
